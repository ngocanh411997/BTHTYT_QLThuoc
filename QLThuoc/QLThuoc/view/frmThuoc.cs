...
namespace QLThuoc.view
{
    public partial class frmThuoc : Form
    {
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            {
                dgvThuoc.DataSource = Bus.TimKiemThuoc("select * from Thuoc where CongDung like '%" + txtTimKiem.Text.Trim() + "%'");
            }
            ...
            {
                dgvThuoc.DataSource = Bus.TimKiemThuoc("select * from Thuoc where NuocSX like '%" + txtTimKiem.Text.Trim() + "%'");
            }
